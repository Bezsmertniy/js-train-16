...
function filterStudentsByGrade(students, grade) {
  //Виведеме в консоль критичну помилку через console.error() з текстом якщо ви бачите це повідомлення завдання 1 виконано не правильно
  ...
  console.error("Критична помилка: завдання 1 виконано неправильно");
